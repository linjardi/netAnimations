var msg = {
	...
	sub12: "O roteador possui uma tabela de repasse que contém uma máscara de sub-rede e um endereço de rede para cada rede. Ele realiza o E lógico entre o IP destino com cada máscara de sub-rede até encontrar o endereço de rede apropriado.",
	...
	html11: "<table class='table table-condensed'>" +
			...
			"<tr>" +
				"<td>&</td>" +
				"<td>10100010.01100111.0000001.01100100</td>" +
				"<td>162.103.1.102</td>" +
				"<td>IP Destino</td>" +
			"</tr>" +
			"<tr>" +
...
var audios = new Array ("../audio/sub/sub1.mp3",
												"../audio/sub/sub2.mp3",
												"../audio/sub/sub3.mp3",
												"../audio/sub/sub4.mp3",
												"../audio/sub/sub5.mp3",
