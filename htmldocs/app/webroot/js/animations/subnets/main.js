...
//	animator.setSteps(new EmptyAnimation(msg.sub7));
	...
	blocks = new BlockAnimation(2,1);
		blocks.setAttributes({"sx": 100, "sy": 450, "dx": 225,"dy": 565, "rotate": 40}, null, true,audiosExtra.a1);
	...
	blocks = new BlockAnimation(2,1);
		blocks.setAttributes({"sx": 350, "sy": 650, "dx": 225,"dy": 565, "rotate": 40}, null, true,audiosExtra.a2);
	...
	blocks = new BlockAnimation(2,1);
		blocks.setAttributes({"sx": 565, "sy": 570, "dx": 925,"dy": 570}, msg.sub13, true,audiosExtra.a2);
