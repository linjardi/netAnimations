init = function() {
	...
	blocks = new BlockAnimation(3,1);
		blocks.setAttributes({"sx":650, "sy":550, "dx":550, "dy":450, "rotate": 40}, msg.interAS.dns7, true, audiosExtra.a1);
	...
	blocks = new BlockBackground(2);
		blocks.setAttributes('ra', "", true, AnimationConf); //RouterAnimation
		blocks.setAttributes('hma', msg.interAS.msg2, false, [ { //HtmlMessageAnimation
			"id": "text3",
			"dx": 210,
			"dy": 120,
			"size": 700,
	...
	animator.setSteps(new BorderRouterAnimation(msg.interAS.msg11,null));
	//animator.setSteps(blocks);
	...
	blocks = new BlockAnimation(2,1);
		blocks.setAttributes({"sx":1030, "sy":450, "dx":800, "dy":450}, msg.interAS.dns7, true, audiosExtra.a2);
	...
	//SESSOES BGP
	blocks = new BlockBackground(2);
		blocks.setAttributes('ra', "", true, AnimationConf2); //RouterAnimation
		blocks.setAttributes('ea', msg.sessaoBGP.msg1); //EmptyAnimation
	animator.setSteps(blocks);

//	animator.setStep(new EmptyAnimation(msg.sessaoBGP.msg2));

	blocks = new BlockBackground(2);
		blocks.setAttributes('ra', msg.sessaoBGP.msg3, true, AnimationConf3); //RouterAnimation
		blocks.setAttributes('hma', null, false,[ { //HtmlMessageAnimation
			"id": "msg1",
			"dx": 325,
			"dy": 120,
			"size": 500,
	...
	blocks = new BlockAnimation(2,1);
		blocks.setAttributes({"sx":350, "sy":450, "dx":575, "dy":550, "rotate": 28}, null, true, audiosExtra.a3);
		blocks.setAttributes({"sx":575, "sy":550, "dx":575, "dy":555, "rotate": 28}, null, true, "");
	animator.setSteps(blocks);

	animator.setSteps(new BorderRouterAnimation(msg.sessaoBGP.msg5, [AnimationConf2.routers2.router1a]));

	blocks = new BlockAnimation(2,1);
		blocks.setAttributes({"sx":575, "sy":550, "dx":350, "dy":450, "rotate": 28}, null, true, audiosExtra.a4);
		blocks.setAttributes({"sx":350, "sy":450, "dx":350, "dy":455, "rotate": 28}, null, true, "");
	animator.setSteps(blocks);

	animator.setSteps(new EmptyAnimation(msg.sessaoBGP.msg6));

	blocks = new BlockAnimation(2,2);
		blocks.setAttributes([{"sx":350, "sy":450, "dx":240, "dy":390, "rotate": 28},{"sx":350, "sy":450, "dx":125, "dy":450, "rotate": 0}], true, null, audiosExtra.a5);
		blocks.setAttributes([{"sx":240, "sy":390, "dx":125, "dy":450, "rotate": -28}], false, null, "");
	animator.setSteps(blocks);

	//ATRIBUTOSBGP

	blocks = new BlockBackground(2);
	blocks.setAttributes('ra', "", true, AnimationConf3); //RouterAnimation
	blocks.setAttributes('ea', msg.atributosBGP.msg1); //EmptyAnimation
	animator.setSteps(blocks);
	...
	blocks = new BlockAnimation(4,2);
		blocks.setAttributes([{"sx":800, "sy":450, "dx":700, "dy":610, "rotate": -54}], true, null, audiosExtra.a6);
	...
	blocks = new BlockAnimation(5,2);
		blocks.setAttributes([{"sx":575, "sy":670, "dx":700, "dy":610, "rotate": -30}], true, null, audiosExtra.a7);
		blocks.setAttributes([{"sx":700, "sy":610, "dx":800, "dy":450, "rotate": -54}], true, null, "");
		blocks.setAttributes([{"sx":800, "sy":450, "dx":925, "dy":390, "rotate": -30}], true, null, "");
		blocks.setAttributes([{"sx":925, "sy":390, "dx":690, "dy":285, "rotate": 30}], true, null, "");
		blocks.setAttributes([{"sx":690, "sy":285, "dx":790, "dy":230, "rotate": -30}], true, null, "");
	animator.setSteps(blocks);
...
/* TODO
 ...
 - imagens diretas nao podem sofrer alteracoes como por exemplo aumentar seu tamanho (vai pixelizar)
