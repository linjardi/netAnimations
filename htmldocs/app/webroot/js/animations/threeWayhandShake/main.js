...
blocks = new BlockAnimation(2,5);
	blocks.setAttributes(ThreeWayConf2,msg.msg8,audiosExtra.a1); //TwhsDecreaseLeft
...
animator.setSteps(new ThreeWayhandShakeAnimation(ThreeWayhandShakeConf, msg.msg9, true));
 ...
 // é necessário ter pelo menos 2 passos em um bloco de animação para que ele consiga executar o audio
	blocks = new BlockAnimation(2,6);
		blocks.setAttributes(ThreeWayConf6,msg.msg14,audiosExtra.a2); //TwhsDecrease
...
// é necessário ter pelo menos 2 passos em um bloco de animação para que ele consiga executar o audio
blocks = new BlockAnimation(2,5);
	blocks.setAttributes(ThreeWayConf2,msg.msg18,audiosExtra.a3); //TwhsDecreaseLeft
