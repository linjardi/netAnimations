...
blocks = new BlockAnimation(2,5);
	blocks.setAttributes(TcpConf2,msg.msg7, audiosExtra.a1); //TwhsDecreaseLeft
...
animator.setSteps(new TcpAnimation(TcpConf, msg.msg8, true));
	...
	blocks = new BlockAnimation(2,6);
	  blocks.setAttributes(TcpConf6,msg.msg10, audiosExtra.a2); //TwhsDecrease
...
blocks = new BlockAnimation(2,5);
  blocks.setAttributes(TcpConf9,msg.msg14, audiosExtra.a3); //TwhsDecreaseLeft
...
blocks = new BlockAnimation(2,5);
  blocks.setAttributes(TcpConf9,msg.msg17, audiosExtra.a4); //TwhsDecreaseLeft
...
blocks = new BlockAnimation(2,6);
  blocks.setAttributes(TcpConf6,msg.msg19, audiosExtra.a5); //TwhsDecrease
